...
{
    public class ExchangeOrderFullExecutedIntegrationEvent : IntegrationEvent
    {
        ...
        public ExchangeOrderFullExecutedIntegrationEvent(int exchangeId, string exchangeOrderId, string baseCurrency, string quoteCurrency, decimal quantityExecuted, decimal price, decimal commisionPaid, string dateClosed)
        {
