...
namespace CryptoArbitrage.Services.Execution.API.Application.DomainEventHandlers.OrderCanceled
{
    public class OrderCanceledDomainEventHandler : INotificationHandler<OrderCanceledDomainEvent>
    {
        ...
        public OrderCanceledDomainEventHandler(ISimpleArbitrageRepository simpleArbitrageRepository, IOrderRepository orderRepository)
        {
        ...
        public async Task Handle(OrderCanceledDomainEvent orderCanceledDomainEvent, CancellationToken cancellationToken)
        {
