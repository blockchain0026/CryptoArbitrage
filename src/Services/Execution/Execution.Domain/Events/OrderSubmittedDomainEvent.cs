...
namespace CryptoArbitrage.Services.Execution.Domain.Events
{
    public class OrderSubmittedDomainEvent : INotification
    {
        ...
        public OrderSubmittedDomainEvent(string orderId, string arbitrageId, Exchange exchange, OrderType orderType, string baseCurrency, string quoteCurrency, decimal price, decimal quantityTotal)
        {
            OrderId = orderId;
