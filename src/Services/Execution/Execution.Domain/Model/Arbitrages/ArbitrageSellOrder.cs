...
{
    public class ArbitrageSellOrder : ValueObject
    {
        public ArbitrageSellOrder(string arbitrageOrderId, int exchangeId, string baseCurrency, string quoteCurrency, decimal price, decimal quantity, decimal slipPrice)
        {
